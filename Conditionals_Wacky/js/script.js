...
var job = prompt("What company do you work for?"); //not needed to make decision, but to produce output.
var hourly = prompt(" How much do you make an Hour?\n (Rounded Up)"); //not needed to make decision, but to produce output.
var raise = prompt("How many years have you been at " + job + "?"); //needed to make a Ternary
...
if(raise >= 2){ //added if else to alert the user of the decision.
